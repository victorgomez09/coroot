...
In situations where an application lacks OpenTelemetry instrumentation, [coroot-node-agent](https://github.com/alvi/alvob-node-agent) can help by capturing outbound 
